...
Installer NodeJS et https://truffleframework.com/ganache[Ganache].
...
npm install
npm install -g truffle@v4 <1>
----
<1> Sur Mac préfixer cette commande par ```sudo```.
...
les codes postaux suivants comme valides : ```Hauteluce```, ```Parly```, ```Beaufort```. +
