...
var JqueryUiForms = function() {
    ...
    var _componentUiDatepicker = function() {
        ...
        $('.datepicker-icon').datepicker({
            showOn: 'button',
            buttonImage: '/static/global_assets/images/ui/datepicker_trigger.png',
    ...
    var _componentUiAutocomplete = function() {
        ...
        $('#ac-caching').autocomplete({
            ...
            source: function(request, response) {
                ...
                $.getJSON('/static/global_assets/demo_data/jquery_ui/autocomplete.php', request, function(data, status, xhr) {
                    cache[ term ] = data;
                    response(data);
                });
            },
